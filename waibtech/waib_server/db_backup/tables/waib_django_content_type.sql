...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(7,'api','entitiesmaster'),(8,'api','entitiesmaster1'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session');
